...
func (s *SmartContract) CertificateUpdate(ctx contractapi.TransactionContextInterface, lotNumber string, totalQuantityProcessed string,processingDate string, verificationDate string,sampleSecretCode string,certificateNo string,certicateDate string,tagSeris string,tagIssuedRangeFrom string,tagIssuedRangeTo string,noOfTagsIssued string,certificateValidityInMonth string) error {
	seed, err := s.QuerySeedByLot(ctx, lotNumber)
...
func (s *SmartContract) testUpdate(ctx contractapi.TransactionContextInterface, lotNumber string, samplePassed string , SampleTestDate string) error {
	seed, err := s.QuerySeedBySecretcode(ctx, lotNumber)
